    ...
    <main className="about">      
      <div className="container">           
        ...
        <div className="about-content"> 
          ...
          <p>Coding and web design caught my attention last year. I'm currently participating in a 1 year frontend developer course called Kodehode, organized by Jobloop AS. </p>
